...
public class CreateCommand extends Command implements ISecuredComponent{
	...
	public CreateCommand(DataTableCommandsToolbar toolbar, IModel<OClass> classModel) {
		super(new ResourceModel("command.create"), toolbar);
		this.classModel = classModel;
	}
	
	public CreateCommand(DataTableCommandsToolbar toolbar, IModel<ODocument> documentModel, IModel<OProperty> propertyModel) {
		super(new ResourceModel("command.create"), toolbar);
