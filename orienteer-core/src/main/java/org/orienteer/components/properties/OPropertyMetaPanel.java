...
import org.orienteer.behavior.RefreshMetaContextOnChangeBehaviour;
import org.orienteer.components.properties.OClassMetaPanel.ListClassesModel;
import org.orienteer.model.ListAvailableOTypesModel;
...
public class OPropertyMetaPanel<V> extends AbstractComplexModeMetaPanel<OProperty, DisplayMode, String, V> {
    ...
    protected void onConfigure() {
        ...
        if (OPropertyPrototyper.TYPE.equals(critery)) {
            ...
            if (metaPanel != null) {
                metaPanel.setVisibilityAllowed(oType != null && oType.isLink());
            }

            // Show Linked Type if type is a some kind of embedded
            metaPanel = getMetaComponent(OPropertyPrototyper.LINKED_TYPE);
            if (metaPanel != null) {
                metaPanel.setVisibilityAllowed(oType != null && oType.isEmbedded());
            }
            ...
            if (metaPanel != null) {
                metaPanel.setVisibilityAllowed(calculable != null && calculable);
            }
        }
    }
