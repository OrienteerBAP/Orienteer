...
/**
 * Default Orienteer implementation of {@link IDataStore}
 */
public class OrienteerDataStore implements IDataStore {
    ...
    private Optional<OWicketData> getWicketData(String sessionId, int id) {
        return DBClosure.sudo(db -> {
            ...
            return getFromIdentifiables(identifiables, OWicketData::new);
        });
    }
