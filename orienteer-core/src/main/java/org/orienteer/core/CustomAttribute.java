...
public final class CustomAttribute
{
	 ...
	 */
	public static final CustomAttribute CALCULABLE = create("orienteer.calculable", OType.BOOLEAN, false, false);
	/**
	 * Script to calculate value of the property
	 */
	public static final CustomAttribute CALC_SCRIPT = create("orienteer.script", OType.STRING, null, true);
	/**
	 * Is this property displayable or not
	 */
	public static final CustomAttribute DISPLAYABLE = create("orienteer.displayable", OType.BOOLEAN, false, false);
	/**
	 * Is this property should be readonly in UI
	 */
	public static final CustomAttribute UI_READONLY = create("orienteer.uireadonly", OType.BOOLEAN, false, false);
	
	/**
	 * Is this property value should not be visible
	 */
	public static final CustomAttribute HIDDEN = create("orienteer.hidden", OType.BOOLEAN, false, false);
	/**
	 * Order of this property in a table/tab
	 */
	public static final CustomAttribute ORDER = create("orienteer.order", OType.INTEGER, 0, false);
	/**
	 * Name of the tab where this parameter should be shown
	 */
	public static final CustomAttribute TAB = create("orienteer.tab", OType.STRING, null, false);
	/**
	 * Name of the property which is storing name of this entity
	 */
	public static final CustomAttribute PROP_NAME = create("orienteer.prop.name", OType.LINK, OProperty.class, null, false);
	/**
	 * Name of property which is storing link to a parent entity
	 */
	public static final CustomAttribute PROP_PARENT = create("orienteer.prop.parent", OType.LINK, OProperty.class, null, false);
	/**
	 * Name of a visualization that should be used for property visualization
	 */
	public static final CustomAttribute VISUALIZATION_TYPE = create("orienteer.visualization", OType.STRING, "default", false);
	/**
	 * Link to an inverse property in respect to this one
	 */
	public static final CustomAttribute PROP_INVERSE = create("orienteer.inverse", OType.LINK, OProperty.class, null, false);
	/**
	 * Description of {@link OProperty} or {@link OClass}
	 */
	public static final CustomAttribute DESCRIPTION = create("orienteer.description",OType.STRING,null,true);

	/**
	 *	Access levels ("_allow", "_allowRead", "_allowUpdate", or "_allowDelete") granted on document creation.
	 */
	public static final CustomAttribute ON_CREATE_FIELDS = create("onCreate.fields",OType.STRING,null,true);

	/**
	 * Identity type ("user" or "role") who will get access rights on document creation.
	 */
	public static final CustomAttribute ON_CREATE_IDENTITY_TYPE = create("onCreate.identityType",OType.STRING,null,true);
    /**
     * Property name by which to sort data by default
     */
	public static final CustomAttribute SORT_BY = create("orienteer.sortby", OType.LINK, OProperty.class, null, false);
    /**
     * Order in which to sort data
     */
	public static final CustomAttribute SORT_ORDER = create("orienteer.sortorder", OType.BOOLEAN, null, false);
	/**
	 * Default search query for class
	 */
	public static final CustomAttribute SEARCH_QUERY = create("orienteer.searchquery", OType.STRING, null, true);
	...
	private CustomAttribute(String name, OType type, Class<?> javaClass, Object defaultValue, boolean encode)
	{
		this.name = name;
		this.type = type;
	...
	public static CustomAttribute create(String name, OType type, Object defaultValue, boolean encode) {
		return create(name, type, type.getDefaultJavaType(), defaultValue, encode);
	}
	...
	public static CustomAttribute create(String name, OType type, Class<?> javaClass, Object defaultValue, boolean encode) {
		...
		ret = new CustomAttribute(name, type, javaClass, defaultValue, encode);
		return ret;
	}
