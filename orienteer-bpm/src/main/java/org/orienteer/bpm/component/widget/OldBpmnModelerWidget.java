 ...
 */
@Widget(id="old-bpmn-modeler", domain="document", selector=ProcessDefinitionEntityHandler.OCLASS_NAME, autoEnable=false)
public class OldBpmnModelerWidget extends AbstractWidget<ODocument> {
	...
	public OldBpmnModelerWidget(String id, IModel<ODocument> model, IModel<ODocument> widgetDocumentModel) {
...
//		} else {
//		}
		TextTemplate template = new PackageTextTemplate(OldBpmnModelerWidget.class, "modeler.tmpl.js");
