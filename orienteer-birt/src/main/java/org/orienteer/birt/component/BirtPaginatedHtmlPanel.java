...
public class BirtPaginatedHtmlPanel extends Panel{
	...
	public BirtPaginatedHtmlPanel(String id,String reportName) {
		this(id,reportName,new HashMap<String,Object>());
	}
	
	public BirtPaginatedHtmlPanel(String id,String reportName,Map<String, Object> parameters) {
		super(id);
		final BirtHtmlPanel birtPanel = new BirtHtmlPanel("report",reportName,parameters);
